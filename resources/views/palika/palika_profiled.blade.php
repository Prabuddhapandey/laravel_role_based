      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <img src="{{!empty($profileData->photo) ? url('upload.palika_image/'.$profileData->photo) :url('upload/no_image.jpg')}}"  alt="Profile" class="rounded-circle">
                ...
                <form>
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <img  id="showImage" src="{{!empty($profileData->photo) ? url('upload.palika_image/'.$profileData->photo) :url('upload/no_image.jpg')}}" alt="Profile">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="name" type="name" class="form-control" id="name" value="{{$profileData->name}}">
                    </div>
                  </div>
