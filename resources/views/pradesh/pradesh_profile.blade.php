      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            <img src="{{$profileData->photo_url}}" alt="Profile" >
          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                ...
                <!-- Profile Edit Form -->
                <form method="POST" action={{route('pradesh.profile.update')}} enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="row mb-3">
                    <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                    <div class="col-md-8 col-lg-9">
                      <img  id="showImage" src="{{$profileData->photo_url}}" alt="Profile" >
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input name="phone" type="" class="form-control" id="phone" value="{{$profileData->phone}}">
                    </div>
                  </div>
